...
<head>
<?php head_tag("LACTOR - "._("Reset Password")); ?>
...
<?php displayMessage('ResetMessage','ResetDetails', 'ResetType'); ?> 
  ...
  <div id="container">
    <div class="tabs">
      ...
      <form id="standardform" action="post/reset_pass.post.php" method="post">
      <pre><?php echo _("Email") ?>:    <input id="standardtextform" type="text" name="email" /><br /></pre>
      <input id="standardsubmit" type="submit" value="<?php echo _("Reset") ?>" />
      </div>
      </form>
    </div>
    </div>   
